...
python process_data.py --t1_dir .\ixi_dataset\IXI-T1 --t2_dir .\ixi_dataset\IXI-T2 --output_dir .\processed_dataset --no_registration --num_subjects 5
...
python train_monai.py --t1_dir ./processed_dataset/IXI-T1 --t2_dir ./processed_dataset/IXI-T2 --batch_size 2 --epochs 5 --num_steps 20 --reflow_steps 3 --use_combined_loss
REM option 2: another model
python efficient_pretrained_flow.py --t1_dir ./processed_dataset/IXI-T1 --t2_dir ./processed_dataset/IXI-T2 --epochs 5 --batch_size 2 --num_steps 20 --freeze_ratio 0.95 --output_dir ./quick_pretrained_results

REM option 3: another training
python simple_pretrained_demo.py --t1_dir ./processed_dataset/IXI-T1 --t2_dir ./processed_dataset/IXI-T2 --num_steps 20 --batch_size 2 --output_dir ./demo_results
